...
-- insert into plant_reservation (id, plant_id, start_date, end_date) values (1, 1, '2017-03-25', '2017-03-28');
--
-- insert into maintenance_plan (id, year_of_action) values (1,2020);
--
--
-- insert into maintenance_task (id,description,type_of_work,price,start_date,end_date) values (1,'CORRECTIVE',)