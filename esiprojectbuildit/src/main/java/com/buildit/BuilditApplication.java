...
//        IntegrationService service = ctx.getBean(IntegrationService.class);
//
//        //System.out.println("checkkkk" +service.findPlants("exc", LocalDate.now(), LocalDate.now().plusDays(20)));
//
//        System.out.println("checkkkk" +service.findPlants(LocalDate.now(), LocalDate.now().plusDays(20)));
